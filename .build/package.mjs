...
/**
 * Package script for plg_system_statistics
...
const pluginName = "plg_system_statistics";
const version = packageJson.version;
const outputFile = `${pluginName}-${version}.zip`;
...
console.log(`Packaging ${pluginName} v${version}...\n`);
